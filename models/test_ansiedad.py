...
class Test_Ansiedad(db.Model):
    ...
    nombre = db.Column(db.String(50), nullable=False, nullable=False)
    descripcion = db.Column(db.String(300), nullable=False, nullable=False)
    n_preguntas = db.Column(db.Integer, nullable=False, nullable=False)
    detalle_escalas = db.Column(db.String(500), nullable=False)
    version = db.Column(db.String(20), nullable=False, nullable=False)
    idiomas_disponibles = db.Column(db.String(300), nullable=False, nullable=False)
    fecha_actualizacion = db.Column(db.Date, nullable=False, nullable=False)
