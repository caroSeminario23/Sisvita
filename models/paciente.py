...
class Paciente(db.Model):
    ...
    usuario = relationship('Usuario', backref='paciente4')
    ...
    def __init__(self, doc_identidad, nombres, apellidos, fec_nacimiento, id_genero, direccion, num_telefono, id_condicion, id_usuario, anio_ingreso=None, id_carrera=None):
